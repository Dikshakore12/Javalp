...
//		FileWriter55 F=new FileWriter55("");
		try 
		{
			...
			FileWriter F=new FileWriter("C:\\Users\\ADMIN\\OneDrive\\Desktop\\Diksha\\dkk.txt");//yha FileWriter hi likhna pdega
			try
				{
					//write operation here.
					F.write("Hello diksha kore!! How was today? How are you? How can help you?");
				}
			finally
			{
